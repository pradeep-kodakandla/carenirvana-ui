...
@Component({
  selector: 'app-member-tasksummary',
  templateUrl: './member-tasksummary.component.html',
  styleUrl: './member-tasksummary.component.css',
  animations: [
...
export class MemberTasksummaryComponent {
