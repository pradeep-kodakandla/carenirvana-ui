...
@Component({
  selector: 'app-umdocumenttype',
  templateUrl: './umdocumenttype.component.html',
  styleUrl: './umdocumenttype.component.css'
})
export class UmdocumenttypeComponent implements OnInit {
  ...
  saveEntry() {
    ...
    if (this.formMode === 'add') {
      ...
      // Save new entry
      this.crudService.addData('um', 'documenttype', this.selectedEntry).subscribe(
        () => {
      ...
      this.crudService.updateData('um', 'documenttype', this.selectedEntry.id, this.selectedEntry).subscribe(
        () => {
  ...
  saveRow(event: MatCheckboxChange, row: any): void {
    ...
    if (confirm(message)) {
      ...
      this.crudService.updateData('um', 'documenttype', row.id, row).subscribe(() => {
        this.loadData();
        this.snackBar.open('Document Type updated successfully!', 'Close', {
          horizontalPosition: 'center',
          verticalPosition: 'top',
  ...
  deleteRow(id: number) {
    this.crudService.deleteData('um', 'documenttype', id, 'current_user').subscribe(
      () => {
