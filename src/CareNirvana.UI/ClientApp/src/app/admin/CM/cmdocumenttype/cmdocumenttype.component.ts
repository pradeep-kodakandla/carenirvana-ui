...
@Component({
  selector: 'app-cmdocumenttype',
  templateUrl: './cmdocumenttype.component.html',
  styleUrl: './cmdocumenttype.component.css'
})
export class CmdocumenttypeComponent implements OnInit {
  ...
  loadData() {
    this.crudService.getData('cm', 'documenttype').subscribe((response) => {
  ...
  saveEntry() {
    ...
    if (this.formMode === 'add') {
      ...
      // Save new entry
      this.crudService.addData('cm', 'documenttype', this.selectedEntry).subscribe(
        () => {
      ...
      this.crudService.updateData('cm', 'documenttype', this.selectedEntry.id, this.selectedEntry).subscribe(
        () => {
  ...
  saveRow(event: MatCheckboxChange, row: any): void {
    ...
    if (confirm(message)) {
      ...
      this.crudService.updateData('cm', 'documenttype', row.id, row).subscribe(() => {
        this.loadData();
        this.snackBar.open('Document Type updated successfully!', 'Close', {
          horizontalPosition: 'center',
          verticalPosition: 'top',
  ...
  deleteRow(id: number) {
    this.crudService.deleteData('cm', 'documenttype', id, 'current_user').subscribe(
      () => {
